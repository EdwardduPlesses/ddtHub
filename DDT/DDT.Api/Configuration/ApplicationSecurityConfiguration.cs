...
namespace DDT.Api.Configuration
{
    public static class ApplicationSecurityConfiguration
    {
        ...
        private static void ConfigureAuthorization(AuthorizationOptions options)
        {
            ...
            options.AddPolicy("Guess", policy => policy.RequireAssertion(context =>
                context.User.HasClaim(c =>
                    c is { Type: "DDT_UserRole", Value: "user" or "admin" })));

            options.AddPolicy("Actual", policy => policy.RequireAssertion(context =>
                context.User.HasClaim(c =>
                    c is { Type: "DDT_UserRole", Value: "admin" })));
        }
    }
}